...
const Navbar = () => {
  ...
  return (
    <>
      <div className="sticky top-0 left-0 w-full px-6 py-6 bg-white flex justify-between z-50 md:px-44 md:py-10">
        <span>
          <svg
      ...
      {/* Mobile Menu */}
      {/* <div
        className={`fixed top-0 w-full h-full bg-[#029e8e] z-50 transform transition-all ease-in-out ${
          menuOpen ? "translate-y-0" : "-translate-y-full"
        }`}
      >
        <div className="relative px-6 text-white font-sans font-bold md:gap-x-4 md:px-44">
          <div className="mb-6 flex justify-between items-center">
            <h4 className="mt-24 mb-6 text-2xl font-extrabold tracking-wider md:mt-0 md:mb-0">
          ...
          <div>
            ...
            <div className="space-y-2 md:pl-12 md:ml-auto md:w-1/2 md:space-y-4">
              ...
              <div className="px-4 py-4 md:px-8 border-t-2 border-white">
                <h4 className="text-xl font-extrabold tracking-wide md:text-3xl">
                  The Blueprint
                </h4>
                <p className="md:text-lg">
